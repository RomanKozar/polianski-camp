					...
					<div className='grid gap-6 md:grid-cols-[minmax(0,0.95fr)_minmax(0,1.35fr)]'>
						...
						>
							...
							<p className='mt-4 text-sm leading-relaxed text-slate-700'>
								Тому що підліток на дієт організовує особливе
								командо-професійне! Ми точимо знання, які активності припадають
								до душі дітям і
								...
								програма насичена різноманітними заходами, які роблять
								відпочинок не тільки веселим, але й корисним для розвитку.
							</p>
